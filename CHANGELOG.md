...
- **Pause / Resume / Reset controls** — Icon buttons (32×32 px) in the docker. Pause freezes both timers; Reset cancels any active overlay or toast and restarts from zero.
